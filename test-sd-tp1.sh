...
docker pull smduarte/sd2425-tester-tp1:latest
docker run --name=tester --rm --network=sdnet -it -v /var/run/docker.sock:/var/run/docker.sock smduarte/sd2425-tester-tp1:latest $*
